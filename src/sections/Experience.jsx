...
const experiences=[
  {
    ...
    duration:"2025",
    description:"Built high performance app,integrated AI features,improved engagement by 10%",
  },
   {
    role:"Web developer Intern",
    company:"Mobisoft Technology",
    duration:"2026",
    description:"Gained  hands on Experience"
  },
   {
    role:"Graduate Engineer",
    company:"HCL  Technology",
    duration:"2027",
    description:"Built frontend of genAi Powered PV intake app with react.js & TS for US client"
  }
]

function ExperienceItem({exp,idx,start,end,scrollYProgress,layout}){
  const scale=useTransform(scrollYProgress,[start,end],[0,1])
  const opacity=useTransform(scrollYProgress,[start,end],[0,1],{ clamp: false })
    ...
    return(
      <div className="relative flex flex-1 justify-center items-center min-w-0">
        ...
        >
          ...
          <p className="text-md text-gray-200 break-words">
            {exp.description}
          </p>
...
export default function Experience(){
  ...
  const thresholds=useMemo(()=>experiences.map((_,i)=>(i+1)/experiences.length),[experiences])
          ...
          <div className="flex flex-1 items-center justify-center px-6 pb-10">
            ...
            {isMobile && (
                   <div className="relative  w-full max-w-md ">
                    <div className="absolute left-0 top-0 bottom-[10%] w-[6px] bg-white/15  rounded">
